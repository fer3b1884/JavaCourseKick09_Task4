...
public class TripsCommand implements Command {
    private static final Logger logger = LogManager.getLogger(TripsCommand.class);
    ...
    public CommandResult execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            request.setAttribute("trips", tripService.findAvailable());
            return CommandResult.forward("/WEB-INF/jsp/trips.jsp");
