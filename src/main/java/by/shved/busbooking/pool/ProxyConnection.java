...
public class ProxyConnection implements Connection {
    ...
    public String enquoteLiteral(String val) throws SQLException {
        return realConnection.enquoteLiteral(val);
    }

    @Override
    public String enquoteIdentifier(String identifier, boolean alwaysDelimit) throws SQLException {
        return realConnection.enquoteIdentifier(identifier, alwaysDelimit);
    }

    @Override
    public boolean isSimpleIdentifier(String identifier) throws SQLException {
        return realConnection.isSimpleIdentifier(identifier);
    }

    @Override
    public String enquoteNCharLiteral(String val) throws SQLException {
        return realConnection.enquoteNCharLiteral(val);
    }
